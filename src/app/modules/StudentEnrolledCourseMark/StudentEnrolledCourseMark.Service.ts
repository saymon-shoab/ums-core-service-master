...
// import { StudentEnrolledCourseMarkUtils } from "./tudentEnrolledCousreMark.utils"
...
const createStudentEnrolledCourseDefaultMark = async (
    prismaClient: Omit<PrismaClient<{errorFormat:"minimal"}, never, DefaultArgs>, "$connect" | "$disconnect" | "$on" | "$transaction" | "$use" | "$extends">,
    payload: {
        studentId: string,
